...
describe("Switch component", () => {
    it("renders label and description", () => {
        render(
            <Switch
                label="Dark Mode"
                description="Enable dark mode for the site"
            />
        );

        expect(screen.getByText("Dark Mode")).toBeInTheDocument();
        expect(screen.getByText("Enable dark mode for the site")).toBeInTheDocument();
    ...
    it("renders state and label in correct order for left/right positions", () => {
        ...
        rerender(<Switch label="RightLabel" switchPosition="right" defaultChecked={false} />);
